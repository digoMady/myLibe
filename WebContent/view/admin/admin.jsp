...
//breadcrumb
	...
	<div class="admin-user">
		<form action="" id="admin-user-form" method="get">
			...
			<input type="button" onclick="aditUser()" value="Editar Usuário" class="mylibe-button">		
			<input type="button" onclick="deleteUse(r" value="Excluir Usuário" class="mylibe-button">
		</form>
